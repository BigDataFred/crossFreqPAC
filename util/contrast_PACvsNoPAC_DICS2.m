%%
restoredefaultpath;
ft = dir(['~rouxf/toolboxes/fieldtrip-*']);
addpath(['~rouxf/toolboxes/',ft.name]);
ft_defaults;

%%
nSources = 10;
p2df = '~rouxf/projects/TC/matFiles/';
files = dir([p2df,'1x_L_thalamic_and_2x_L_cortical_dipoles_alphagammaPAC_SNR1_nRandSources',num2srt(nSources),'_realMEG.mat']);

%%
for ot = 1:length(files)
    
    [SNR] = files(ot).name(regexp(files(ot).name,'SNR')+3);    
    [nSources] = files(ot).name(regexp(files(ot).name,'Sources')+7:max(regexp(files(ot).name,'_'))-1);
    
    load([p2df,'1x_L_thalamic_and_2x_L_cortical_dipoles_alphagammaPAC_SNR',SNR,'_nRandSources',nSources,'_realMEG.mat']);
    load([p2df,'1x_L_thalamic_and_2x_L_cortical_dipoles_nonrhythmic_SNR',SNR,'_nRandSources',nSources,'_realMEG.mat']);
...
%         clear common_csd2;
    ...
    savename1 = ['dics_PAC_sourceMap_alpha_1x_L_thalamic_and_2x_L_cortical_dipoles_alphagammaPAC_SNR',SNR,'_nRandSources',nSources,'_realMEG.mat'];
    savename2 = ['dics_noPAC_sourceMap_alpha_1x_L_thalamic_and_2x_L_cortical_dipoles_nonrhythmic_SNR',SNR,'_nRandSources',nSources,'_realMEG.mat'];
    savename3 = ['dics_PAC_sourceMap_gamma_1x_L_thalamic_and_2x_L_cortical_dipoles_alphagammaPAC_SNR',SNR,'_nRandSources',nSources,'_realMEG.mat'];
    savename4 = ['dics_noPAC_sourceMap_gamma_1x_L_thalamic_and_2x_L_cortical_dipoles_nonrhythmic_SNR',SNR,'_nRandSources',nSources,'_realMEG.mat'];    
